class ContaController {
    ...
    inserir(evento) {
        ...
        const elementoDataAniversario = document.querySelector('#dataAnivesario');
        ...
        else if(elementoTipoConta.value == 'contaPoupanca'){
            const conta = new Poupanca(elementoNumero.value, Number(elementoSaldo.value), elementoDataAniversario.value);
                
            this.repositorioContas.adicionar(conta);
            this.inserirContaNoHTML(conta);
        } 
        else if(elementoTipoConta.value == 'contaBonificada'){
